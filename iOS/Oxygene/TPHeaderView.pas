...
method TPHeaderView.initWithWidth(aWidth: CGFloat) caption(aCaption: String): id;
begin
...
method TPHeaderView.drawRect(rect: CGRect);
begin
...
class method TPHeaderView.headerHeight: CGFloat;
begin
